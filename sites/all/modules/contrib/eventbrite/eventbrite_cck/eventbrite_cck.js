...
//  $('fieldset.eventbrite_cck-new-venue-toggle').hide();
  ...
  // If Event Venue "toggle" is displayed, hide unselected fieldsets
...
//  if ($('fieldset.eventbrite_cck-existing-venue-toggle').length) {
//    window.alert('yeah');
//  $('fieldset.eventbrite_cck-existing-venue-toggle').hide();
//  }
//  if ($('fieldset.eventbrite_cck-new-venue-toggle').length) {
 //   window.alert('yeah');
 // $('fieldset.eventbrite_cck-new-venue-toggle').hide();
 // }
